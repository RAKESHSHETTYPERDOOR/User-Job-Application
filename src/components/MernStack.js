    ...
    return(
      <div class="container">
       <button type="button" class="btn btn-light" style={{padding:'10px',marginLeft:'10px'}}><Link to='/admin'>Back</Link></button>
         <h1 style={{padding:"10px"}}>MERN-Stack Developer</h1>
         <h4 style={{padding:"10px"}}>List of-candidated applied for MERN-stack Jobs</h4>

         <table border="1" border="1" class="table table-striped  table-bordered"  >
             <thead >
